...
const T=[
  ...
  ["qué es un espía",/🕵️ un espía de EDTU/],["dame una misión",/🕵️ tu misión/],["qué hice ayer",/📖 lo último/],["mi mejor partida",/./],["cuántos puntos tengo",/no hay niveles/],["cómo comparto",/COMPARTIR/],["dónde estoy",/Sala de Trofeos/],["cómo llamo al helicóptero",/🚁 rescates/],["qué hago con el huevo",/huevo/],
  ["cuéntame algo de ti",/soy WALLY/],["qué hay de nuevo",/MEJORAS/],["novedades",/MEJORAS/],["te acuerdas de mí",/🧠 ¡claro que recuerdo/],["borra todo",/cosa seria/],["cómo borro mi nombre",/olvida mi nombre/],["habla más despacio",/velocidad 0\.9/],["sube el volumen",/volumen 100%/],["velocidad normal",/velocidad 1\.05/],["apaga la música",/no hay música/],["habla en inglés",/a little bit/],["hello",/hello, agent/],["how are you",/I'm great/],["thank you",/welcome/],["10 elevado a 3",/= 1000/],["el doble de 8",/= 16/],["la mitad de 50",/= 25/],["(2+3)*4",/= 20/],["convierte 3 km a metros",/= 3000 metros/],["2 horas a minutos",/= 120 minutos/],["cuántos segundos tiene un día",/86\.400/],
  ["socorro",/🆘 ¡aquí estoy/],["help",/🆘/],["no me funciona",/soporte de WALLY/],["no tengo sonido",/sin sonido/],["cómo instalo edtu",/📲 instalar/],["pantalla completa",/F11/],["cómo juego en el celular",/táctiles/],["funciona con mando",/RT acelera/],["qué teclas uso",/⌨️ controles/],["cómo pauso",/⏸ pausa/],["cómo guardo",/se guarda solo/],["perdí mis récords",/ESTE navegador/],["puedo jugar sin internet",/📴/],["es gratis",/🆓/],["quién hizo los juegos",/David programó/],
  ["chiste de dinos",/tesauro-rex/],["cuántos chistes sabes",/un montón/],["cuánto es pi",/3,14159/],["infinito más uno",/♾️/],["dime un número del 1 al 10",/🎲 \d+ \(entre 1 y 10\)/],["elige entre jurassic y scream",/JURASSIC|SCREAM/],["juguemos a las escondidas",/🙈/],["veo veo",/👀 veo veo/],["pista",/💡 pista: tiene \d+ letras/],["me rindo",/era «/],["piedra papel o tijera",/di 'piedra'/],["cuánto es cero por cero",/= 0/],["cuántos son 3 más 4",/= 7/],["cuánto es 2 elevado a 10",/\(2\^10\) = 1024/],["tabla del 13",/13×7=91/],["tabla del 0",/0×5=0/],["adivinanza",/🧠 adivinanza/],["tabla del 3",/3×3=9/],["me rindo",/era «/],["trivia de dinosaurios",/dinosaurio|T-rex/i],["b",/./],["chiste",/./],["de nuevo",/robot|médico|batería|virus|despide|binario|🎲|chiste/],
  ["qué animal es el más rápido",/guepardo/],["habla más rápido",/velocidad/],["cuántos planetas hay",/8 planetas/],["por qué se extinguieron los dinosaurios",/asteroide/],["qué es un bug",/polilla/],["quién inventó el teléfono",/Meucci/],["qué es javascript",/David me programó/],["quiero aprender a programar",/console\.log/],["cuántos huesos tiene un gato",/230/],["dónde queda chile",/Andes/],
  ...
  ["wally cuéntame de ti",/soy WALLY/],["hay multijugador",/👥 EDTU es de un jugador/],["puedo jugar con mi hermano",/👥/],["mi hermano juega mejor",/rétalo/],["mi mamá me dijo que parara",/hazles caso/],["ranking",/🏆 en EDTU el ranking/],["récord de scream",/./],["cuántos metros hice",/./],["mis kills",/./],
  ["cuántos minutos faltan para las 8",/⏰ para las 8:00 faltan/],["qué hora es en 2 horas",/serán las \d+:\d\d/],["cuánto falta para mañana",/🌙 para mañana faltan/],["qué día es el 25 de diciembre",/📅 el 25 de diciembre de \d{4} es (lunes|martes|miércoles|jueves|viernes|sábado|domingo)/],["cuántos días hasta el 18 de septiembre",/faltan \d+ días? \(cae en/],["cuántos días tiene septiembre",/septiembre tiene 30 días/],["qué mes viene después de agosto",/viene septiembre/],["cuántas semanas faltan para navidad",/semanas? \(\d+ días\) para navidad/],["cuántos días faltan para navidad",/🎄 faltan \d+ días para navidad/],["cuántos años tengo",/tienes 11 años|aún no me lo has dicho/],["cuándo es mi cumpleaños",/🎂/],["mi cumple es el 5 de mayo",/apuntado/],["en qué día cae mi cumpleaños",/🎂 tu cumpleaños cae en/],["mi cumpleaños es en marzo",/qué día de marzo/],["hoy es mi cumpleaños",/FELIZ CUMPLEAÑOS/],["feliz cumpleaños a mí",/FELIZ CUMPLEAÑOS/],["es fin de semana",/✅|❌/],["qué día de la semana es",/📅 hoy es/],["qué estación es",/🗓️ en Chile estamos en/],["hace calor",/🌤️/],
  ["qué",/completa la pregunta/],["por qué",/completa la pregunta/],["sí o no",/🎱 bola mágica/],["quizás",/🎱 bola mágica/],["bola mágica ¿ganaré hoy?",/🎱/],["no sé qué preguntar",/💡 idea/],["pregúntame tú",/💡 idea/],["cheats",/no hay trampas/],["vidas infinitas",/no hay trampas/],["nitro infinito",/no hay trampas/],["cómo hago trampa",/no hay trampas/],["quiz de mates",/🧮/],["me rindo",/./],
  ["hola soy david",/encantado, David/],["cómo me llamo",/te llamas David/],["hola me llamo sofía",/encantado, Sofía/],["yo soy david",/encantado, David/],["no soy david",/perdón/],["llámame capitán",/a la orden, Capitán/],["cómo me llamo",/te llamas Capitán/],["llámame agente",/a la orden, agente/],["soy espía",/te digo «agente»/],["soy un robot",/otro robot/],["eres real",/tan real como el código/],["me extrañaste",/💛|🥹|🤖/],["tienes familia",/mi familia es EDTU/],["david es tu papá",/mi familia es EDTU/],["cuál fue mi última pregunta",/🧠/],["soy el hermano de david",/VIP/],["olvida mi nombre",/agente/],
...
for(const [q,re] of T){ let r=""; try{ window._wallyPrevQ=store.edtu_wally_last||""; r=String(fn(q)); store.edtu_wally_last=q.slice(0,40); }catch(e){ r="❌ EXCEPCIÓN: "+e.message; }
  const p=re.test(r) && !/error de circuitos/.test(r); if(p) ok++; else bad++; console.log((p?"✅ ":"❌ ")+q.padEnd(30)+" → "+r.replace(/\n/g," ").slice(0,90)); }
...
for(let i=0;i<60;i++){ const len=1+Math.floor(Math.random()*24); let q=""; for(let j=0;j<len;j++) q+=AL[Math.floor(Math.random()*AL.length)]; try{ window._wallyPrevQ=""; const r=fn(q); if(typeof r!=="string"||!r.length) throw new Error("respuesta vacía o no-string"); if(/error de circuitos/.test(r)) throw new Error("excepción interna (error de circuitos)"); fz++; }catch(e){ bad++; console.log("❌ fuzz «"+q+"» → "+e.message); } }
