...
## 🆕 Cuadragésima segunda tanda (iter 736-745) — WALLY te conoce
- 🙋 **WALLY te llama por tu nombre**: "me llamo X" lo guarda (`edtu_agent_name`; o usa el nombre del agente logueado) y desde entonces sustituye "agente" en el chat, en el saludo de la Sala y en los avisos de SCREAM, JURASSIC y NOT A GAME; "cómo me llamo / quién soy", "olvida mi nombre"
- 🎂 **Cumpleaños**: "mi cumpleaños es el 14 de marzo" lo guarda, "cuánto falta para mi cumpleaños" cuenta los días y el día señalado WALLY te felicita al abrir la Sala (una vez por año)
- 🎄 **"cuánto falta para navidad / año nuevo / halloween / las fiestas patrias"** (días exactos; "navidad" y "fiestas patrias" a secas conservan sus respuestas 🎅🇨🇱)
- 🤖 **"quién eres / quién te creó / preséntate"**: WALLY se presenta (lo creó David, vive en edtu.cl, lo que sabe hacer)
- 📖 **"cuéntame un cuento"**: cuento aleatorio con héroes, lugares, problemas y finales de los mundos de EDTU · ✖️ **"tabla del N"**
...
## 🆕 Cuadragésima cuarta tanda (iter 756-765) — WALLY profe
- 🇬🇧 **"cómo se dice X en inglés"**: diccionario de espía de ~120 palabras (lo pronuncia en inglés con la voz activada) y **"quiz de inglés"** (pregunta, pista con la primera letra, "me rindo", aciertos)
- 🧠 **"trivia / quiz / pregúntame algo"**: 12 preguntas con a) b) c) sobre dinos, arañas, el cubo, el espacio, F1, Chile y el cuerpo humano, con explicación y aciertos · **"sabías que / dato curioso"**: 15 datos curiosos
- 💡 **Trucos del chat**: 18 trucos; "qué más sabes / dame un consejo" da uno al azar y el saludo de la Sala muestra un **truco del día** (una vez al día)
- 💬 Chips 🧠 trivia · 🇬🇧 inglés; "marcador del chat", "estadísticas" y el bloque JUEGOS DEL CHAT de la Sala incluyen inglés y trivia; corrector y "ayuda" al día
...
## 🆕 Cuadragésima octava tanda (iter 796-805) — 🎉 800 mejoras, WALLY conversador II y soporte
- 🎉 **¡800 MEJORAS!** WALLY celebra las ochocientas en el saludo, en "gracias", en "mejoras" y en su presentación
- 🕵️ Ronda 5: "qué es un espía", "misión / dame una misión" (→ desafío del día), "qué hice ayer" (→ diario), "mi mejor/peor partida", "cuántos puntos / qué nivel soy" (→ hitos), "cómo comparto", "dónde estoy", "helicóptero / rescate" (NAG y JURASSIC), "qué hago con el huevo"
- 🧠 Ronda 6: "cuéntame algo de ti", "qué hay de nuevo / novedades", "te acuerdas de mí" (memoria), "borra todo" (seguridad), "cómo borro mi nombre", **ajustes de voz** ("habla más despacio", "sube el volumen", "velocidad normal" — también dentro de los juegos), "apaga la música", **inglés básico** (hello, how are you, what is your name, thank you, bye), mates ("elevado a", "el doble / la mitad / el triple de", paréntesis), **conversiones** (km↔m, horas↔minutos, kg↔g, litros↔ml) y "cuántos segundos tiene un día"
- 🛠️ Ronda 7: "socorro / help / menú / no entiendo" → ayuda, **soporte técnico** ("no funciona", "se traba", "sin sonido", "pantalla negra"), "cómo instalo edtu", "pantalla completa", **controles** (celular, mando, teclas, saltar, disparar, pausar, salir, guardar), "perdí mis récords / cambié de celular", "sin internet", "es gratis", "quién hizo los juegos"
- 📚 Corrector, "ayuda" y trucos del día al día · 🧪 Test del chat: **225 preguntas + fuzz 60** (todo verde; atrapó 3 choques más y una llave perdida antes de publicar)
- 📄 RESUMEN con la Cuadragésima séptima tanda
- 🩺 Chequeo de salud en 805: todo verde (Heroku v1723, 751 commits desde el 26/8, test 225/225 + fuzz 60/60)

## 🆕 Cuadragésima novena tanda (iter 806-815) — WALLY enciclopedia y anfitrión
- 🎲 Ronda 8: la adivinanza y el quiz de inglés **ya no se tragan comandos**, chistes por tema (dinos, arañas, zombies, F1, robots, cubo, gato, espías, fútbol), trivia por tema, tabla del 0 al 20, números en palabras ("cero por cero"), potencias con ^, pi e infinito, "dime un número del 1 al 10", "elige entre X y Y", escondidas, **veo veo** (con pista y "me rindo"), arranque de piedra-papel-tijera, "de nuevo / otra ronda / reintentar"
- 📚 Ronda 9: **enciclopedia de bolsillo** — 32 respuestas de animales, dinos, espacio, geografía, Chile, inventos y programación (qué es un robot / internet / JavaScript / una variable / un bug, cómo se hace un videojuego); 🐛 "qué animal es el más rápido" activaba los ajustes de voz
- 🚀 Ronda 10: **onboarding** ("soy nuevo", "tutorial", "por dónde empiezo"), "soy niño/niña" ya no es un nombre, "tengo N años", "adivina mi edad / mi nombre", **descripciones de cada mundo** ("de qué se trata F1", "qué es NOT A GAME"), juego más fácil/difícil, "dime algo", "shhh" apaga la voz; y el saludo ofrece la guía a los recién llegados (una vez)
- 📚 "ayuda", "juegos del chat", trucos del día y corrector al día · 🧪 Test del chat: **275 preguntas + fuzz 60** (todo verde; atrapó 4 choques más)
- 📄 RESUMEN con la Cuadragésima octava tanda
- 🩺 Chequeo de salud en 815: todo verde (Heroku v1734, 758 commits desde el 26/8, test 275/275 + fuzz 60/60)

## 🆕 Quincuagésima tanda (iter 816-825) — WALLY, 50 tandas después
- 💬 Ronda 11: "buenas noches" (ya no responde "buenos días"), felicitaciones, "tengo que irme / ya vuelvo" y "volví" (recuerda de qué hablaban), "perdón", "gracias por…", "muy bueno / me gustó", "no me gustó" (otro chiste), "más difícil / más fácil" (ajusta el quiz), "no puedo / es imposible" (ánimo + trucos), "qué es el sigilo", "dame una pista" sin juego activo
- 🎯 Ronda 12: "dame un reto" (desafío del día + retos del chat), "cómo funciona el desafío / hay premios", "cómo voy / mi progreso / resumen", "resumen de hoy", **hábitos sanos** ("jugué mucho", "es tarde", "mañana tengo colegio"), **"tengo tarea"** (practicar sumas, restas, tablas, inglés)
- 🗣️ Ronda 13: el **prefijo "wally"** se quita ("wally abre jurassic", "hey wally cuánto es 2+2"), "juguemos a adivinar / a las adivinanzas / a piedra papel tijera" arrancan el juego del chat, la adivinanza y el quiz ya no se tragan temas sueltos, "cuentos", "datos curiosos", "examen / preguntas / test" → trivia, "palabras", "colores", "animales", 5 datos de dinos
- 👥 Ronda 14: multijugador / jugar con amigos o hermanos (retar con COMPARTIR, turnarse, RPS contra WALLY), comentarios de familia, "ranking / récord mundial", récords por mundo
- 🧪 El test trata cualquier "error de circuitos" (excepción interna) como fallo — atrapó una **TDZ** real (`const pick` declarada dentro de `wallyReply`: los handlers nuevos con `pick` deben ir después) y 4 choques de orden más · **329 preguntas + fuzz 60**
- 📖 README.md: sección "Juegos y WALLY" (22 juegos, Sala, chat con voz y micrófono, desafío del día, `npm test`)
- 📄 RESUMEN con la Cuadragésima novena tanda
- 🩺 Chequeo de salud en 825: todo verde (Heroku v1745, 766 commits desde el 26/8, test 329/329 + fuzz 60/60)

## 🆕 Quincuagésima primera tanda (iter 826-835) — WALLY calendario, bola mágica e identidad
- 📅 Ronda 15: **reloj** ("cuántos minutos faltan para las 8", "qué hora es en 2 horas", "cuánto falta para mañana"), **fechas** ("qué día cae el 25 de diciembre", "cuántos días hasta el 18 de septiembre", "cuántos días tiene septiembre", "qué mes viene después de agosto", "en qué día cae mi cumpleaños"), semanas para navidad, cumpleaños y edad ("cuántos años tengo", "cuándo es mi cumpleaños", "hoy es mi cumpleaños"), día de la semana ("es fin de semana", "mañana es lunes") y **estaciones/clima de Chile**
- 🎱 Ronda 16: palabras de pregunta sueltas ("qué", "por qué"), **bola mágica** ("sí o no", "quizás"), "no sé qué preguntar", trampas y cheats (no hay: secretos y trucos legales), "quizás" ya no arranca la trivia
- 🙋 Ronda 17: "hola soy david" / "yo soy david" guardan el nombre, **títulos** ("llámame capitán / jefe / campeón"), "no soy david", familia de David, "soy espía" ya no es un nombre (explica por qué dice "agente"), "soy un robot", "¿eres real? ¿existes?", "me extrañaste", "cuál fue mi última pregunta", la familia de WALLY
- 🐛 Dos bugs de regex cazados: `\b` no funciona tras vocal acentuada ("a mí") y "david" nunca debe estar en la lista de no-nombres
...
## 🆕 Quincuagésima tercera tanda (iter 846-855) — WALLY motivador, robot y compañero de juegos
- 🌟 Ronda 23: **valores y motivación** — qué es el amor / la amistad / la felicidad / un sueño / la valentía, cómo hacer amigos / ser feliz / valiente / mejor en los juegos, frases motivadoras ("motívame", "tengo flojera", "frase del día"), tiempo de pantalla responsable, palabra y dato del día, plan de espía para hoy
- 🤖 Ronda 24: **charla de robot** — cómo se hace un robot (sensores, cerebro, motores; mBot, Arduino, el LAFVIN de David), vida interior (cerebro, corazón, sentimientos, sueños), "qué piensas de mí", opiniones y "te equivocaste", verdad y promesas, cariño ("abrázame", "choca"), despedidas de espía ("cambio y fuera"), "apágate"
- 🎮 Ronda 25: preguntas precisas de los mundos (el lago, "cómo escapo", la vitrola y la linterna, el Dr. VZ, los sectores de F1, ganar a la IA del CUBO)
- 💬 Ronda 26: **jerga de chat** — letras alargadas (holaaaa, siiii), "porfa / plis", abreviaturas (xq, k, tqm, bn, ntp, tb, salu2, 100pre, d nada), "holiwis", "okk", "dalee", "xdxd"
- 🔗 Ronda 27: **dos peticiones en una** ("la hora y un chiste", "2+2 y 3+3", "primero un chiste después la hora") y formato clave: valor ("nombre: david", "edad: 11", "cumpleaños: 14 de marzo")
- 🪝 Ronda 28: **AHORCADO en el chat** (20 palabras de EDTU con pista, letras o palabra entera, 6 fallos, contador en la Sala y en "estadísticas"), colmos, "qué le dijo un X a otro", toc toc, veo veo al revés, Simón dice, lagarto/Spock, chistes por tema II
...
## 🆕 Quincuagésima quinta tanda (iter 866-875) — WALLY logros, cuentacuentos y chileno
- 🕹️ Ronda 37: **guías y reglas de los 17 minijuegos** (ajedrez con movimientos y jaque mate, 2048, buscaminas, conecta 4, fútbol, flappy…), cuál es más difícil / más fácil, IA en los tableros
- 🏅 Ronda 38: **los 21 logros con ✅/▫️** por mundo (SCREAM y JURASSIC por dificultad, kills de NAG, metros de F1, WALLYs escondidos y el huevo), cuáles faltan, leyenda y CUBO DE ORO, lista de secretos, dificultades PESADILLA/INFIERNO y EXTINCIÓN
- ⚔️ Ronda 39: quién gana un reto, contadores de retos, qué hacer con un link, link roto, www.edtu.cl, invitar amigos, la racha explicada
- 📖 Ronda 40: **cuentacuentos** — cuentos por tema (terror, para dormir, de WALLY, de David), **historia entre los dos** (colaborativa por turnos con "fin"), "otro cuento / otro chiste", feedback, elogios y notas ("te doy 10 puntos", "5 estrellas"), chistes de WALLY y David
- 🎮 Ronda 41: **después de jugar** — "acabo de jugar X", marcas contadas ("hice 1200 metros" comparado con el récord de F1, "junté 4 pistas", "maté 30 zombies" con logros), "batí mi récord", "casi", "una más", "mamá dice que me vaya"
- 🇨🇱 Ronda 42: **Chile** — terremotos y tsunamis con pasos de seguridad, historia (O'Higgins, Prat, Mistral y Neruda, Valdivia y Lautaro, Manuel Rodríguez, el 18), cueca, volantín, comida típica, regiones, bandera, himno, escudo y copihue
